...
impl Default for UIState {
    fn default() -> Self {
        Self {
            url: String::new(),
            title: String::from("Fusion Terminal Browser"),
...
impl TerminalUI {
    ...
    /// Draw the UI
    pub fn draw(&mut self, state: &UIState, content: &[Line]) -> Result<()> {
        self.terminal
            .draw(|f| {
                let size = f.area();
    ...
    pub fn handle_events() -> Result<Option<UIEvent>> {
