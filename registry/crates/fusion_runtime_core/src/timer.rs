//! # Low-Jitter Timer
//!
//! Monotonic clock source and timer interface that bypasses standard OS
//! scheduling jitter. Essential for financial and QPU control loops.
//!
//! ## Performance
//!
...
impl<'a> Deadline<'a> {
    ...
    pub fn remaining(&self) -> Option<Duration> {
        ...
        if now >= self.target_ns {
            None
        } else {
            Some(Duration::from_nanos(self.target_ns - now))
        }
    }
}
