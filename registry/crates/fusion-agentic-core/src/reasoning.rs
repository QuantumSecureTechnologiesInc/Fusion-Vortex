...
impl ReasoningSession {
    ...
    pub fn add_premise(&mut self, premise: String) {
...
impl ReasoningProcessor {
    ...
    pub fn deduce(&mut self, premises: Vec<String>) -> Result<Vec<String>> {
    ...
    pub fn induce(&mut self, observations: Vec<String>) -> Result<Vec<String>> {
