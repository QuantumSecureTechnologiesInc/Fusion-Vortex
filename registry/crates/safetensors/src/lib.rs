...
impl SafeTensorsParser {
    ...
    pub fn parse_header(data: &[u8]) -> StdResult<SafeTensorsMetadata> {
        ...
        if header_len as usize > 100 * 1024 * 1024 {
            // 100MB limit
