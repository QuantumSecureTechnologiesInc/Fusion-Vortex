...
impl PluginEngine {
    ...
    pub async fn call(&self, plugin: &Plugin, func_name: &str, _args: Vec<i32>) -> Result<()> {
...
#[cfg(not(feature = "wasm"))]
impl PluginEngine {
    pub fn new(_runtime: crate::executor::RuntimeHandle) -> Result<Self> {
