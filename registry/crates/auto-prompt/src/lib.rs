...
use fusion_ai_core::{Optimizer, SGD};
...
pub struct PromptOptimizer {
    ...
    pub soft_prompt_vector: Variable, // [Prompt Length, Embed Dim]
}

impl PromptOptimizer {
    pub fn new(prompt_len: usize, embed_dim: usize, learning_rate: f64) -> Self {
        let soft_prompt_vector = Variable::new(Matrix::zeros([prompt_len, embed_dim]));
        let optimizer = SGD::new(vec![soft_prompt_vector.clone()], learning_rate);
        
        Self { optimizer, soft_prompt_vector }
    }
