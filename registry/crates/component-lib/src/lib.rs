...
pub enum ComponentType {
    ...
    Card(String),
    Input(String),
    ChartRef(String), // Reference to a chart generated by fusion_ui_data_vis
}
...
pub struct ComponentProps {
    ...
    pub children: Vec<ComponentProps>,
    pub data_hook: Option<String>, // Hook name for Fusion state access
}
