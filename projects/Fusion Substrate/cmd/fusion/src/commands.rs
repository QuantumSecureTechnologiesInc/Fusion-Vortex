...
use crate::{AiCommands, PackageCommands};
...
pub fn mcp(cmd: crate::McpCommands) -> Result<()> {
    ...
    match cmd {
        ...
        Context { cmd } => match cmd {
            crate::ContextCommands::Add { path, recursive } => {
