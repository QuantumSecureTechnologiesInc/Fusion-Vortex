...
type ResourceHandler = Box<dyn Fn(Request, HashMap<String, String>) -> Response + Send + Sync>;
...
impl RestServer {
    ...
    where F: Fn(Request, HashMap<String, String>) -> Response + Send + Sync + 'static
    {
        // Simple routing implementation (no complex regex matching for demo)
        self.routes.insert((method.to_string(), path_pattern.to_string()), Box::new(handler));
    }
