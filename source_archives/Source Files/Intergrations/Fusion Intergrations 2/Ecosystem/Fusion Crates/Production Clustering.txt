...
impl KMeans {
    ...
    pub fn fit(&mut self, data: &Matrix<f64>) -> FusionResult<()> {
        ...
        // ... (Iteration logic with convergence check vs self.tol) ...
        Ok(())
    }
}