...
impl VM {
    ...
    fn run(&mut self) -> InterpretResult {
        ...
        loop {
            ...
            // println!("IP: {}, Inst: {:?}, Stack: {:?}", frame.ip, instruction, self.stack);
            frame.ip += 1;
            ...
            match instruction {
                ...
                } // _ => { ... } // Compiler checks exhaustiveness so we might need wildcards if OpCodes grow
            }
        }
