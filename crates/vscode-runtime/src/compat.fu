...
pub struct ExtensionCompatibility {
    ...
    #[serde(default)]
    pub required_ui_features: FVec<UiFeature>,
    /// Reason for current compatibility level
    #[serde(default)]
    pub fallback_reason: Option<FString>,
}
...
impl ExtensionCompatibility {
    pub fn new(id: impl Into<FString>, level: CompatibilityLevel) -> Self {
        Self {
            id: id.into(),
            level,
    ...
    pub fn is_runnable_in(&self, environment: CompatibilityLevel) -> FBool {
