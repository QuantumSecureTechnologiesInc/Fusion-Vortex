...
pub struct FunctionInstance {
    pub image_id: String,
    // Runtime execution context pointer or process handle
    pub is_hot: bool,
}

pub struct FaasRunner {
    instances: Arc<Mutex<HashMap<String, FunctionInstance>>>,
    // Cold start pool management
}
