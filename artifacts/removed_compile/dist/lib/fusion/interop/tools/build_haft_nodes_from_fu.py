...
CRATE_DIR = ROOT / "ecosystem" / "haft_mesh_nodes_v1"
OUT_DIR = ROOT / "dist" / "haft_nodes"
BUILD_TARGET_DIR = Path("/mnt/c/Projects/haft_nodes_build")
...
def main() -> None:
    ...
    for name in ("haft_solver", "haft_vault", "haft_nexus", "haft_warden"):
