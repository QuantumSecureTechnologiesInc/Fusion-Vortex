...
impl LockFile {
    ...
    pub fn verify_checksums(&self, _cache_dir: &Path) -> Result<(), String> {
        for pkg in &self.packages {
            // TODO: Compute actual checksum from cached package
            // and compare with pkg.checksum
...
impl LockedPackage {
    pub fn from_package(package: &Package, checksum: String) -> Self {
        LockedPackage {
