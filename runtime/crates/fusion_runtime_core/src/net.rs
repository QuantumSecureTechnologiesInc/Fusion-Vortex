...
impl TcpStream {
    ...
    pub async fn writable(&self) -> Result<()> {
        // Simplified - in real implementation, would register with I/O reactor
        yield_now().await;
        Ok(())
    }
}
...
// Helper function to yield control
async fn yield_now() {
    struct YieldNow {
        yielded: bool,
    }
