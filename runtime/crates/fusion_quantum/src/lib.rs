    ...
    pub fn measure(&mut self) -> u8 {
        ...
        match self.state {
            ...
            QubitState::Superposition => {
                ...
                let result = if rand_bool() { 1 } else { 0 };
...
/// Simple pseudo-random boolean generator
fn rand_bool() -> bool {
