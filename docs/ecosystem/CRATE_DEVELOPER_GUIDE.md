# Fusion v2.0 Vortex Crate Ecosystem - Developer Guide
...
Welcome to the Fusion v2.0 Vortex Programming Language crate ecosystem. This guide provides an overview of the architecture, organization, and best practices for working with Fusion crates.

## Ecosystem Architecture

The Fusion v2.0 Vortex ecosystem follows a layered architecture organized into six archetypes:
