# Fusion v2.0 Vortex Programming Language: Comprehensive Overview (Part 2)
...
The heart of the Fusion v2.0 Vortex language. Contains the compiler implementation (lexer, parser, type checker, code generator), the bytecode VM, and the core type system. This crate is self-hosting—it's written in Fusion and compiles itself.
