...
impl AgentMessage {
    pub fn new(from: Uuid, to: Uuid, message_type: String, payload: serde_json::Value) -> Self {
        Self {
            from,
            to,
            message_type,
